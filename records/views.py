...
from .forms import SnakeFeedingForm, AnimalCleaningForm, AnimalHealthForm
from.forms import SnakeForm,  CleaningFilterForm, BasicFilterForm

def index(request):
    animal_instances_list = list(Snake.objects.all())
...
def feeding_records(request):
    ...
    feeding_instances_list = list(query1.all())
